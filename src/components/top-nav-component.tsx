  ...
  return (
    <div className="bg-white h-[90px] flex gap-5 items-center px-[20px] md:px-[30px] font-lexend py-4">
      ...
      <div className="flex gap-3">
        <div
          className="w-[30px] h-[30px] md:w-[44px] md:h-[44px] rounded-[50%] bg-secondary text-white flex items-center justify-center font-[500] font-sans text-[16px] md:text-[20px]"
        >
          MH
        </div>
        <div className="hidden md:flex flex-col">
          <span className="text-[14px]">Anonymous Fellow</span>
          <span className="text-[12px] font-[300]">anonymous@mail.com</span>
        </div>
      </div>
    </div>
  );
