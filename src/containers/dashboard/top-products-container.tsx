    ...
    <div className=" bg-[#FFFFFF66] border-[1px] border-white rounded-[32px] p-[15px] flex flex-col gap-4 w-full">
      <div className="flex justify-between items-center">
        <div className="flex gap-2 items-center">
          <div className="h-[38px] w-[38px] rounded-[16px] flex items-center justify-center bg-[#DB094B] text-white">
            <PiPackage size={18} />
          </div>
          <h3 className="text-[16px] font-[600]">Top Performing Products</h3>
        </div>
